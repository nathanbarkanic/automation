...
test("can search Google twice", async () => {
  ...
  await driver.findElement(By.name("q")).sendKeys("pedal steel guitar", Key.RETURN);

  await driver.wait(until.titleIs("pedal steel guitar - Google Search"), 1000);
  
  await driver.findElement(By.name("q")).clear()

  await driver.findElement(By.name("q")).sendKeys("yodeling", Key.RETURN);

  await driver.wait(until.titleIs("yodeling - Google Search"), 1000);
